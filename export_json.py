...
def get_mesh_animation_string():
	return TEMPLATE_ANIMATION_FILE % {
...
def export_mesh_animation( filepath ):
	write_file( filepath, strip_file( get_mesh_animation_string() ) )
	print("writing animations", filepath, "done")
...
def save( operator, context, properties ):
	filepath = ensure_extension(properties.filepath, ".json")
